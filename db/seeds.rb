# レディース
lady = GoodsItem.create(name: "レディース")
...
# ベビー・キッズ
baby_kids = GoodsItem.create(name: "ベビー・キッズ")
...
# インテリア・住まい・小物
interior_residence_accessory = GoodsItem.create(name: "インテリア・住まい・小物")
...
# 本・音楽・ゲーム
book_music_game = GoodsItem.create(name: "本・音楽・ゲーム")
...
# おもちゃ・ホビー・グッズ
toy_hobby_goods = GoodsItem.create(name: "おもちゃ・ホビー・グッズ")
...
# コスメ・香水・美容
cosme_perfume_beauty = GoodsItem.create(name: "コスメ・香水・美容")
...
# 家電・スマホ・カメラ
appliance_smartphone_camera = GoodsItem.create(name: "家電・スマホ・カメラ")
...
# スポーツ・レジャー
sport_leisure = GoodsItem.create(name: "スポーツ・レジャー")
...
# ハンドメイド
handmade = GoodsItem.create(name: "ハンドメイド")
...
# チケット
ticket = GoodsItem.create(name: "チケット")
...
# 自動車・オートバイ
car_motorcycle = GoodsItem.create(name: "自動車・オートバイ")
...
# その他
others = GoodsItem.create(name: "その他")
